...
public class JwtService {
    ...
    public JwtToken getJwtToken(String email) {
        ...
        if(userRefreshToken ==null) {
            ...
            //access, refresh 토큰 생성
            JwtToken jwtToken = jwtProviderService.createJwtToken(user.getId(), user.getEmail());
        ...
        //refresh 토큰이 있는 사용자(기존 사용자)
            ...
            if(accessToken !=null) {
                ...
                JwtToken newJwtToken = jwtProviderService.createJwtToken(user.getId(), user.getEmail());
